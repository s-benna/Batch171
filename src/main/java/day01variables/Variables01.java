...
public class Variables01 {
    ...
    public static void main(String[] args) {
        ...
        * {}==>eleman yok  {0}==> elemani sifir
        ...
        //float data type:
        //(Decimal Numbers ==> ondalikli sayilar) icin kullanilir. (fiyatlandirma=7.99)

        //Ornek 8: Gomlek ve ayakkabi fiyatlari icin iki tane variable olusturunuz.
        float shirtPrice = 12.99f; // nokta ile kusurat yazilir. virgul kullanilmaz.
        float shoesPrice = 15.99f;

        //Note: Java ondalikli sayilari otomatik olara double kabul eder.
        //float olmasina israr ederseniz sonun  'F'  veya  'f'  koyulur.
        //4 byte yer kaplar.
        ...
        // Ornek 9: Hucre agirligi ve amip'in agirligi icin bir variable olustrunuz.

        double weightCell=0.00000000000000000000112;
        double weightAmip=0.00000000000000000000015;
        //Ogrenci notlari icin iki adet variable olusturunuz ve toplamlarini ekrana yazdiriniz.

        //----------------ekrana yazdirmak icin----------------
        System.out.println(5);//ekran yazdirmak icindir.
        ...
        /* homework
        1-3 farkli data turunde variable olusturun ve bunlari farkli satirda yazdirin.
        2-Ulke ve sehir isimleri icin iki variable olusturun ve yazdirin.
        3-iki tamsayi turunde variable olusturup yazdirin.
